      ...
      <div className="mt-6">
        ...
        <div className="mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <select value={comuna} onChange={(e) => setComuna(e.target.value)} className="border p-2 rounded">
            ...
            <select value={estrato} onChange={(e) => setEstrato(e.target.value)} className="border p-2 rounded">
            ...
            <select value={grupoEtnico} onChange={(e) => setGrupoEtnico(e.target.value)} className="border p-2 rounded">
            ...
            {registrosFiltrados.map((registro) => (
              <tr key={registro.id} className="text-sm">
                ...
                <td className="py-2 px-4 border">
                  <button onClick={() => handleDelete(registro.id)} className="text-red-600 hover:underline">
                    Eliminar
                  </button>
                </td>
              </tr>
